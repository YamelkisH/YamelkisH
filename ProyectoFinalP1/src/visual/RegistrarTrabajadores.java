...
public class RegistrarTrabajadores extends JDialog {
	...
	private JSpinner spnDependientes;
				...
				if(validos()) {
					...
					case 0:
						if (Integer.parseInt(spnExperiencia.getValue().toString()) >= 0) {
							...
							int dependientes = Integer.parseInt(spnDependientes.getValue().toString());

							trabajador = new Jefe(id, cedula, nombres, apellidos, direccion, genero, edad, celular, correo, salarioHoras, dependientes,experiencia);
						} else {
					...
					//		}
							trabajador = new Programador(id, cedula, nombres, apellidos, direccion, genero, edad, celular, correo,salarioHoras);
					//		for (String string : lenguajes) {
							//	((Programador) trabajador).insertLanguages(string);
						//	}
					//	} else {
					...
					case 2: 
						...
						//	aux = new Diseñador(id,cedula, nombres, apellidos, direccion, genero, edad, celular, salarioHoras, correo);
						} else {
